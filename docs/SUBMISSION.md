...
On 500 cases it recovers ₹17.6 lakh net against ₹4.5 lakh for doing nothing and ₹15.8 lakh for
naive automation — with zero rule violations against the naive policy's 2,256, and one dispute
against its 126.
