...
from bharpai.core.models import Case, Method
    ...
    def create_payment_link(
        ...
        *,
        ...
        payload: dict[str, Any] = {
            ...
            "reference_id": f"bharpai-{case.id}-{int(now.timestamp())}",
            "customer": {
                "name": case.customer_first_name,
                "email": case.customer_email or None,
                "contact": case.customer_contact or None,
            },
            # Bharpai owns the reminder schedule; the platform's own cadence would double up on it
            # and break the caps the policy engine enforces.
            "notify": {"sms": False, "email": False},
            "reminder_enable": False,
            "notes": {
                "bharpai_case_id": case.id,
