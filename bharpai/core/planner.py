...
It can only choose from what :class:`~bharpai.core.policy.PolicyEngine` allows. It cannot invent an
...
from bharpai.core import taxonomy
...
class RulesPlanner:
    """Deterministic planner. No model, no randomness — the baseline Bharpai has to beat."""
