...
from bharpai.adapters.composer import Composer, build_context
from bharpai.adapters.humanqueue import HumanQueue
from bharpai.adapters.messaging import Messenger
from bharpai.adapters.templates import escalation_brief
...
class Executor:
    ...
    def _contact(self, action, case: Case, now, result: ExecutionResult, rule_ids) -> None:
        ...
        if not check.ok:
            ...
            from bharpai.adapters.templates import render
