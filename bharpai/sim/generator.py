...
from bharpai.core.models import Case, Channel, ErrorTriple, Language, Method, RootCause, Scenario
from bharpai.core.taxonomy import REASON_TO_CAUSE
from bharpai.sim.customer import HiddenCase, HiddenCustomer, Population
...
def _add_outage(world: World, case: Case, rng) -> None:
    from bharpai.sim.world import Downtime
