...
| MANDATE_ISSUE | 24 | 12% | 12% | 12% | 29% | 29% |
| MERCHANT_CONFIG | 10 | 10% | 10% | 10% | 100% | 100% |
| OVERDUE_RECEIVABLE | 79 | 14% | 52% | 66% | 58% | 60% |
...
- 298 replies read, 92.3% matched what the customer meant
- 285 read by the language model, 13 by pattern alone
...
- model calls: 600 (335 served from cache, 292 failed)
- budget exhausted mid-run: True

## Writing messages — agent

- 897 messages sent; 47 written by the model, 850 from templates
- guardrail rejections (R40), replaced by a template: 1
- asked for Hinglish 36 times; genuinely Hinglish 36 (100%) — the rest were English with a Hindi sign-off
